...
// DeployServiceSpec defines the desired state of DeployService
type DeployServiceSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of DeployService. Edit deployservice_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// DeployServiceStatus defines the observed state of DeployService
...
func init() {
	SchemeBuilder.Register(&DeployService{}, &DeployServiceList{})
}
